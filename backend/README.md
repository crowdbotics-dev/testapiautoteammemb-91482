...
## Project Structure
    ...
    ├── testapiautoteammemb_91482  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_91482`
...
2. Clone this repo and `cd testapiautoteammemb_91482`
